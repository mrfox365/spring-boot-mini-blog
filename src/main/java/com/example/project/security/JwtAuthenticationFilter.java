...
/**
 * Filter that intercepts incoming HTTP requests to validate JWT tokens stored in HttpOnly cookies.
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
   ...
   * Extracts the JWT from the "jwtToken" cookie instead of the Authorization header.
   *
